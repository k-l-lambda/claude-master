...
Create a game of 3 dimensional Tetris.
Run in browser.
The tetris pool is a quadrilateral prism with bottom of 4*4.
User can use keyboard to rotate and move tetris.
Support an AI mode, play by itself.
