...
* When Worker accomplished a response, Instructor will get a message like: `Worker says: ...`
...
Instructor has permissions of file reading, writing & git actions.
Worker has all permissions except git or other dangerous actions.

User will be able to watch conversations from 2 instances in console.
